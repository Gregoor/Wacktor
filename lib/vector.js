...
var valsOf = function valsOf(args) {
  ...
  if (args.length > 1 || nx instanceof Vector) {
    var v = new (_bind.apply(Vector, [null].concat(_toConsumableArray(args))))();
    return [v.x, v.y];
  }
  return [nx, nx];
};
...
var Vector = (function () {
  ...
  _createClass(Vector, [{
    ...
    value: function sub() {
      ...
      var _valsOf32 = _slicedToArray(_valsOf3, 2);
    ...
    value: function mul() {
      ...
      var _valsOf4 = valsOf(args);

      var _valsOf42 = _slicedToArray(_valsOf4, 2);
